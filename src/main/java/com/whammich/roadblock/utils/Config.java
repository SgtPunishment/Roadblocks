...
public class Config {
	...
	private static String[] roadblocksDefault = { "minecraft:stone",
			"minecraft:dirt", "minecraft:cobblestone", "minecraft:log",
			"minecraft:log:1", "minecraft:log:2", "minecraft:log:3",
			"minecraft:log2", "minecraft:log2:1", "minecraft:planks",
			"minecraft:planks:1", "minecraft:planks:2", "minecraft:planks:3",
			"minecraft:planks:4", "minecraft:planks:5", "minecraft:sand",
			"minecraft:sand:1", "minecraft:gravel", "minecraft:lapis_block",
			"minecraft:sandstone", "minecraft:sandstone:1",
			"minecraft:sandstone:2", "minecraft:wool", "minecraft:wool:1",
			"minecraft:wool:2", "minecraft:wool:3", "minecraft:wool:4",
			"minecraft:wool:5", "minecraft:wool:6", "minecraft:wool:7",
			"minecraft:wool:8", "minecraft:wool:9", "minecraft:wool:10",
			"minecraft:wool:11", "minecraft:wool:12", "minecraft:wool:13",
			"minecraft:wool:14", "minecraft:wool:15", "minecraft:gold_block",
			"minecraft:iron_block", "minecraft:brick_block",
			"minecraft:bookshelf", "minecraft:mossy_cobblestone",
			"minecraft:obsidian", "minecraft:diamond_block",
			"minecraft:coal_block", "minecraft:ice", "minecraft:snow",
			"minecraft:clay", "minecraft:pumpkin", "minecraft:netherrack",
			"minecraft:soul_sand", "minecraft:stonebrick",
			"minecraft:stonebrick:1", "minecraft:stonebrick:2",
			"minecraft:stonebrick:3", "minecraft:mycelium",
			"minecraft:nether_brick", "minecraft:end_stone",
			"minecraft:emerald_block", "minecraft:quartz_block",
			"minecraft:quartz_block:1", "minecraft:quartz_block:2",
			"minecraft:hardened_clay", "minecraft:stained_hardened_clay",
