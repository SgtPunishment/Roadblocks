...
public class Config {
	...
	private static String[] roadblocksDefault = { "minecraft:stone",
			...
			"minecraft:cobblestone", "minecraft:planks", "minecraft:planks:1",
			"minecraft:planks:2", "minecraft:planks:3", "minecraft:planks:4",
			"minecraft:planks:5", "minecraft:sand", "minecraft:sand:1",
			"minecraft:gravel", "minecraft:log", "minecraft:log:1",
			"minecraft:log:2", "minecraft:log:3", "minecraft:glass",
			"minecraft:lapis_block", "minecraft:sandstone",
			...
			"minecraft:diamond_block", "minecraft:ice", "minecraft:snow",
			"minecraft:clay", "minecraft:pumpkin", "minecraft:netherrack",
			"minecraft:soul_sand", "minecraft:glowstone",
			"minecraft:stained_glass", "minecraft:stained_glass:1",
			"minecraft:stained_glass:2", "minecraft:stained_glass:3",
			"minecraft:stained_glass:4", "minecraft:stained_glass:5",
			"minecraft:stained_glass:6", "minecraft:stained_glass:7",
			"minecraft:stained_glass:8", "minecraft:stained_glass:9",
			"minecraft:stained_glass:10", "minecraft:stained_glass:11",
			"minecraft:stained_glass:12", "minecraft:stained_glass:13",
			"minecraft:stained_glass:14", "minecraft:stained_glass:15",
			...
			"minecraft:stained_hardened_clay:15", "minecraft:log2",
			"minecraft:log2:1", "minecraft:coal_block", };
	...
	public static void syncConfig() {
		...
		roadblocks = config
				.get(category, "roadblocksToCreate", roadblocksDefault,
