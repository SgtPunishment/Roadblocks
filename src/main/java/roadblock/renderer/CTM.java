...
public class CTM
{
    ...
    private static boolean isConnected(IBlockAccess world, int x, int y, int z, int side, Block block)
    {
        int x2 = x, y2 = y, z2 = z;
        ...
        return getBlock(world, x, y, z, side).equals(block) && (!getBlock(world, x2, y2, z2, side).equals(block));
    }

    private static Block getBlock(IBlockAccess world, int x, int y, int z, int side) {
